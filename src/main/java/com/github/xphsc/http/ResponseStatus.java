...
public enum ResponseStatus {
    ...
    public boolean is1xxInformational() {
        return ResponseStatus.Series.INFORMATIONAL.equals(this.series());
    }

    public boolean is2xxSuccessful() {
        return ResponseStatus.Series.SUCCESSFUL.equals(this.series());
    }

    public boolean is3xxRedirection() {
        return ResponseStatus.Series.REDIRECTION.equals(this.series());
    }

    public boolean is4xxClientError() {
        return ResponseStatus.Series.CLIENT_ERROR.equals(this.series());
    }

    public boolean is5xxServerError() {
        return ResponseStatus.Series.SERVER_ERROR.equals(this.series());
    }
    ...
    public static enum Series {
        ...
        public static ResponseStatus.Series valueOf(int status) {
