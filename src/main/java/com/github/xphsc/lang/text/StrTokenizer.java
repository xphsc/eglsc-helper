package com.github.xphsc.lang.text;
...
public class StrTokenizer implements ListIterator<String>, Cloneable {
    ...
    public StrTokenizer(final char[] input) {
        super();
        this.chars = ArrayUtil.clone(input);
    }
  ...
  /*  public StrTokenizer(final char[] input, final StrMatcher delim) {
     ...
     * @param quote  the field quoted string character
     */
  /*  public StrTokenizer(final char[] input, final StrMatcher quote) {
        this(input, delim);
        setQuoteMatcher(quote);
    }*/
     ...
     */
    private int readNextToken(final char[] srcChars, int start, final int len, final
    StrBuilder workArea, final List<String> tokenList) {
