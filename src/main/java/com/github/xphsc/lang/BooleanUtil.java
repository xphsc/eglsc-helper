...
import com.github.xphsc.util.NumberUtil;
...
public class BooleanUtil {
    ...
    public static Integer toIntegerObject(Boolean bool) {
        return bool == null?null:(bool.booleanValue()?NumberUtil.INTEGER_ONE:NumberUtil.INTEGER_ZERO);
    }
    ...
    public static Boolean and(Boolean... array) {
        if(array == null) {
            ...
            try {
                boolean[] ex = ArrayUtil.unWrap(array);
                return and(ex)?Boolean.TRUE:Boolean.FALSE;
    ...
    public static Boolean or(Boolean... array) {
        if(array == null) {
            ...
            try {
                boolean[] ex = ArrayUtil.unWrap(array);
                return or(ex)?Boolean.TRUE:Boolean.FALSE;
            } catch (NullPointerException var2) {
                throw new IllegalArgumentException("The array must not contain any null elements");
            }
        }
    ...
    public static Boolean xor(Boolean... array) {
        if(array == null) {
            ...
            try {
                boolean[] ex =ArrayUtil.unWrap(array);
                return xor(ex)?Boolean.TRUE:Boolean.FALSE;
            } catch (NullPointerException var2) {
                throw new IllegalArgumentException("The array must not contain any null elements");
            }
        }
