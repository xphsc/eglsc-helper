...
public class Validator {
    ...
    public static boolean isNullOrEmpty(Object value) {
        return null == value?true:(value instanceof CharSequence? StringUtils.isBlank((CharSequence) value):(isCollectionsSupportType(value)? CollectionUtils.sizeIsEmpty(value):false));
    }
